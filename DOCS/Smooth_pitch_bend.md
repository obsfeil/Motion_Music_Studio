// MUSIKK: Smooth pitch bend
float alpha = 0.1f;
current_freq = current_freq * (1-alpha) + target_freq * alpha;

// MOTOR: Smooth akselerasjon  
float alpha = 0.1f;
current_rpm = current_rpm * (1-alpha) + target_rpm * alpha;

Request

{
  `path`: `C:\\Users\\obsfe\\workspace_ccstheia\\Motion_Music_studio\\PITCH_BEND_VS_MOTOR_CONTROL.md`,
  `content`: `# 🎵⚙️ Pitch Bend vs Motor Control: Perfekt Analogi!

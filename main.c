/**
 * @file main.c
 * @brief MSPM0G3507 Synthesizer - STATE INITIALIZATION FIX
 * @version 1.3.4-state-fix
 * @date 2025-12-19
 * 
 * CRITICAL FIX:
 * - Explicit zero-initialization of g_synthState in .data section
 * - Removed all global initializers (moved to main())
 * - Fixed GPIO_LCD pin usage in lcd_driver.c compatibility
 */
...
//=============================================================================
// GLOBAL STATE - CRITICAL: Zero-initialized
//=============================================================================

// CRITICAL FIX: Declare without initializer to force .bss placement
...
static void float_to_string(float value, char *buffer, uint8_t buffer_size, uint8_t decimals) {
...
//=============================================================================
// MAIN - CRITICAL STATE INITIALIZATION
//=============================================================================
...
int main(void) {
    ...
    // Step 2: CRITICAL - Zero-initialize entire state structure
    memset(&g_synthState, 0, sizeof(SynthState_t));
    
    // Step 3: Set initial values AFTER memset
    ...
    LCD_DrawString(35, 90, "v1.3.4", COLOR_YELLOW);
    delay_ms(2000);
